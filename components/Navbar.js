  ...
  return (
    <div className="flex justify-center sticky top-0 px-10 bg-zinc-900/40 backdrop-blur-lg z-10">
      <div className="w-full max-w-[700px] flex justify-between items-center py-8">
        <h1 className="font-semibold text-2xl">Shreyas Waykar</h1>
        <div className="hidden sm:flex gap-3">
          ...
          <div className="relative group w-fit p-2 border-[1px] rounded-full cursor-pointer hover:bg-zinc-600">
            <a href="https://twitter.com/ShreyasMWDev" target="blank">
          ...
          <div className="relative group w-fit p-2 border-[1px] rounded-full cursor-pointer hover:bg-zinc-600">
            <a
              href="https://www.linkedin.com/in/shreyaswaykar/"
              target="blank"
            >
          ...
          <div className="relative group w-fit p-2 border-[1px] rounded-full cursor-pointer hover:bg-zinc-600">
            <a href="http://github.com/username-copied" target="blank">
          ...
          <div className="relative group w-fit p-2 border-[1px] rounded-full cursor-pointer hover:bg-zinc-600">
            <a href="mailto:shreyas.waykar@gmail.com" target="blank">
        ...
        <a className="inline-block sm:hidden underline" href="https://twitter.com/ShreyasMWDev" target="blank">Twitter</a>
        </div>
      </div>
    </div>
  );
